...
Coding an HTML page does not require any special tools. It's entirely possible to write a valid HTML, CSS, or JavaScript page using a bare-bones 
...
as Raider (or any other web server), which can be helpful to find issues such as using the wrong path format for linked files and images.
